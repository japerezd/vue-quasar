<template>
  <q-page class="">
    ...
    <div class="bg-dark column q-mb-md items-center">
      <div class="square-box bg-primary"></div>
      <div class="square-box bg-secondary"></div>
      <div class="square-box bg-accent"></div>
    </div>

    <div class="bg-dark column q-mb-md items-end">
      <div class="square-box bg-primary"></div>
      <div class="square-box bg-secondary"></div>
      <div class="square-box bg-accent"></div>
    </div>
    ...
    <div
      class="bg-dark column custom-height q-mb-md items-center justify-center"
    >
      <div class="square-box bg-primary"></div>
      <div class="square-box bg-secondary"></div>
      <div class="square-box bg-accent"></div>
    ...
    <div
      class="bg-dark column custom-height q-mb-md items-center justify-between"
    >
      <div class="square-box bg-primary"></div>
      <div class="square-box bg-secondary"></div>
      <div class="square-box bg-accent"></div>
